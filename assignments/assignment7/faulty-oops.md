...
x20: 00000055596ba990 x19: ffffff8001c20600 x18: 0000000000000000
...
## Oops Analysis
The page fault occurred due to a null pointer dereference. This is indicated by the first line in the log:
```Unable to handle kernel NULL pointer dereference at virtual address 0000000000000000```

The line in the log:
```pc : faulty_write+0x10/0x20 [faulty]```
indicates that the module in which the error occurred is called faulty. The function, faulty_write, executed 0x10 bytes of 0x20 bytes before faulting.
